...
s.addMsgHandler("/load", receive_OSC)
...
t_inversion = Tkinter.Checkbutton(text="Allow Inversions", offvalue=0, onvalue=1,variable=v_inversion, command=send_inversion)
